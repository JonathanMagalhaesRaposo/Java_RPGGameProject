        ...
        while (boss2.getBossVida() > 0 && (guerreironv1.getVida() > 0 || magonv1.getVida() > 0)) {
            ...
            while (boss2.getBossArmadura() > 0) {
                if (guerreironv1.getAtaqueFisico() <= boss2.getBossDestreza()) {
                    ...
                    System.out.printf("A armadura do Boss caiu para %d, devido ao seu ataque.%n",
                            boss2.getBossArmadura());
                }
                ...
                System.out.printf("A armadura do Boss caiu para: %d, devido ao ataque mágico.%n",
                        boss2.getBossArmadura());
                boss2.setBossArmadura(boss2.getBossArmadura() - magonv1.getAtaqueFogo());
                System.out.printf("A armadura do Boss caiu para: %d, devido ao ataque de fogo.%n",
                        boss2.getBossArmadura());
